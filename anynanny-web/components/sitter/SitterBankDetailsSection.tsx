...
import { sitterBankSummary } from "@/components/personal-area/personal-area-summaries";
...
export function SitterBankDetailsSection({ sitterId, className = "" }: SitterBankDetailsSectionProps) {
  ...
  return (
    <div className={className}>
      <PersonalAreaSection
        title="פרטי בנק"
        description="למשיכת רווחים מהארנק"
        summary={loading ? "טוען…" : sitterBankSummary(filled)}
      >
