-- Public Parent ID (P-####) on profiles — mirrors sitter AN-#### serials.
-- Prefer the bundled migration: supabase/migrations/20260625120000_profiles_parent_public_id.sql
...
comment on column public.profiles.parent_public_id is
  'Human-friendly public identifier for parents, e.g. "P-1001".';
