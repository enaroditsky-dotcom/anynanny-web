-- Expose expert pricing (pricing_model / package_price_nis) on public search + profile RPCs.
-- Also harden get_sitter_profile_public against missing optional columns (400s).
...
-- ---------------------------------------------------------------------------
-- get_sitter_profile_public — safe JSON projection + pricing fields
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- list_public_sitters_search — include pricing_model + package_price_nis
-- ---------------------------------------------------------------------------
do $$
declare
  r record;
