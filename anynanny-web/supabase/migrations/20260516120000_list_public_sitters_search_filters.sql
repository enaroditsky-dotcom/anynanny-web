-- Parameterized parent search: nanny serial, date, experience, transport, max hourly rate.
...
grant execute on function public.list_public_sitters_search(text, timestamptz, int, text, numeric) to authenticated;
