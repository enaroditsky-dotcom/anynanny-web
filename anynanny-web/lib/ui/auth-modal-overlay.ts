...
export const AUTH_MODAL_CARD_SHELL =
  `my-auto flex min-h-0 w-full max-w-sm flex-col overflow-hidden rounded-3xl bg-white shadow-2xl ${AUTH_MODAL_CARD_MAX_H}`;

export const AUTH_MODAL_CARD_SHELL_MD =
  `my-auto flex min-h-0 w-full max-w-md flex-col overflow-hidden rounded-3xl bg-white shadow-2xl ${AUTH_MODAL_CARD_MAX_H}`;
...
export const AUTH_MODAL_FOOTER =
  "flex shrink-0 items-center justify-end gap-2 border-t border-slate-100 bg-white px-5 py-3";
